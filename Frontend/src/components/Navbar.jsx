...
function Navbar() {
  ...
  return (
    ...
    <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${
        sticky?"sticky-navbar shadow-md bg-base-200 duration-200 transition-all ease-in-out":" md:px-20 px-4 "
    }`}>
        ...
        <div className="navbar-start">
            ...
            <a className="text-2xl font-bold cursor-pointer">SKILLFORGE</a>
        </div>
        ...
        <input type="text" className="text-white outline-none grow dark:bg-slate-900" placeholder="Search" />
